...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="ae-page-body">
        ...
        <body>   <!-- add any of your classes or IDs -->
            ...
            <footer>
                <div id="elixir-banner" data-color="#5E8CC0" data-name="This service" data-description="ArrayExpress is an ELIXIR Core Data Resource" data-more-information-link="https://www.elixir-europe.org/platforms/data/core-data-resources" data-use-basic-styles="false"></div>
                <script defer="defer" src="https://dev.ebi.emblstatic.net/web_guidelines/EBI-Framework/v1.3/js/elixirBanner.js"></script>
