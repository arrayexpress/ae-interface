...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="ae-page-body">
        ...
        <body>   <!-- add any of your classes or IDs -->
            ...
            <footer>
                <div id="elixir-banner" data-color="grey" data-name="This service" data-description="ArrayExpress is an ELIXIR Core Data Resource" data-more-information-link="https://www.elixir-europe.org/platforms/data/core-data-resources" data-use-basic-styles="false"></div>
