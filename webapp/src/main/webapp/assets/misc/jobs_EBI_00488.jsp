...
<div id="wrapper" class="container_24">
    <header>
        <div id="global-masthead" class="masthead columns medium-12"><a href="//www.ebi.ac.uk/" title="Go to the EMBL-EBI homepage"><img src="//www.ebi.ac.uk/web_guidelines/images/logos/EMBL-EBI/EMBL_EBI_Logo_white.png" alt="EMBL European Bioinformatics Institute"></a><nav><ul id="global-nav"><li class="first active" id="services"><a href="//www.ebi.ac.uk/services">Services</a></li><li id="research"><a href="//www.ebi.ac.uk/research">Research</a></li><li id="training"><a href="//www.ebi.ac.uk/training">Training</a></li><li id="industry"><a href="//www.ebi.ac.uk/industry">Industry</a></li><li id="about" class="last"><a href="//www.ebi.ac.uk/about">About us</a></li></ul></nav></div>
        <div id="local-masthead" class="masthead columns medium-12 nomenu"><div id="local-title" class="logo-title columns medium-6"><img class="svg" src="/arrayexpress/assets/images/ae-logo-64.svg" width="64" height="64" alt="AE"><span><h1><a href="/arrayexpress/" title="Back to ArrayExpress homepage">ArrayExpress</a></h1></span></div><div class="columns medium-6 last"><form id="local-search" name="local-search" action="/arrayexpress/search" method="get"><fieldset><div class="left"><label><input type="text" name="query" id="local-searchbox"></label>
            ...
            <div class="right"><input type="submit" value="Search" class="submit button"><span class="adv"><a href="/arrayexpress/help/how_to_search.html#AdvancedSearchExperiment" id="adv-search" title="Advanced">Advanced</a></span></div></fieldset></form></div>
            <nav><ul class="columns medium-12" id="local-nav"><li class="first"><a href="/arrayexpress/" title="ArrayExpress 2.0">Home</a></li><li><a href="/arrayexpress/experiments/browse.html" title="Experiments">Experiments</a></li><li><a href="/arrayexpress/arrays/browse.html?directsub=on" title="Arrays">Arrays</a></li><li><a href="/arrayexpress/submit/overview.html" title="Submit">Submit</a></li><li><a href="/arrayexpress/help/index.html" title="Help">Help</a></li><li><a href="/arrayexpress/about.html">About ArrayExpress</a></li><li class="functional last"><a href="#" class="icon icon-functional login" data-icon="l">Login</a></li><li class="functional"><a href="#" class="icon icon-static feedback" data-icon="\">Feedback</a></li></ul></nav></div></header><div id="content" role="main" class="columns medium-12 clearfix"><section id="ae-login" style="display:none"><h3>ArrayExpress submitter/reviewer login<a id="ae-login-close" href="#" class="icon icon-functional" data-icon="x"></a></h3><form id="ae-login-form" method="post" action="/arrayexpress/auth"><fieldset><label for="ae-user-field">User name</label><input id="ae-user-field" name="u" maxlength="50"></fieldset><fieldset><label for="ae-pass-field">Password</label><input id="ae-pass-field" type="password" name="p" maxlength="50"></fieldset><span id="ae-login-remember-option"><input id="ae-login-remember" name="r" type="checkbox"><label for="ae-login-remember">Remember me</label></span><input class="submit button" type="submit" value="Login"><div class="ae-login-status" style="display:none"></div><div id="ae-login-forgot"><a href="#">Forgot user name or password?</a></div></form><form id="ae-forgot-form" method="post" action="/arrayexpress/auth"><fieldset><label for="ae-name-email-field">User name or email address</label><input id="ae-name-email-field" name="e" maxlength="50"></fieldset><fieldset><label for="ae-accession-field">Experiment accession associated with the account</label><input id="ae-accession-field" name="a" maxlength="14"></fieldset><div>We will send you a reminder with your account information</div><div class="ae-login-status" style="display:none"></div><input class="submit button" type="submit" value="Send"></form></section><section id="ae-feedback" style="display:none"><h3>Have your say<a id="ae-feedback-close" href="#" class="icon icon-functional" data-icon="x"></a></h3><form method="post" action="#" onsubmit="return false"><fieldset><label for="ae-feedback-message">We value your feedback. Please leave your comment below.</label><textarea id="ae-feedback-message" name="m"></textarea></fieldset><fieldset><label for="ae-email-field">Optionally please enter your email address if you wish to get a response.<br>We will never share this address with anyone else.</label><input id="ae-email-field" name="e" maxlength="50"></fieldset><input type="hidden" name="p" value="/arrayexpress/jobs/EBI_00488/"><input type="hidden" name="r" value="/arrayexpress/"><input class="submit button" type="submit" value="Send"></form></section>
    <section class="columns medium-12">
        ...
        %>
    </section></div><footer><div id="global-footer" class="columns medium-12"><nav id="global-nav-expanded"><div class="columns medium-2"><h3 class="embl-ebi"><a href="//www.ebi.ac.uk/" title="EMBL-EBI">EMBL-EBI</a></h3></div><div class="columns medium-2"><h3 class="services"><a href="//www.ebi.ac.uk/services">Services</a></h3></div><div class="columns medium-2"><h3 class="research"><a href="//www.ebi.ac.uk/research">Research</a></h3></div><div class="columns medium-2"><h3 class="training"><a href="//www.ebi.ac.uk/training">Training</a></h3></div><div class="columns medium-2"><h3 class="industry"><a href="//www.ebi.ac.uk/industry">Industry</a></h3></div><div class="columns medium-2 last"><h3 class="about"><a href="//www.ebi.ac.uk/about">About us</a></h3></div></nav><section id="ebi-footer-meta"><p class="address">EMBL-EBI, Wellcome Trust Genome Campus, Hinxton, Cambridgeshire, CB10 1SD, UK &nbsp; &nbsp; +44 (0)1223 49 44 44</p><p class="legal">Copyright © EMBL-EBI 2013 | EBI is an Outstation of the
